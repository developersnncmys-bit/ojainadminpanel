...
import { stats, salesData, categorySplit, orders, topProducts } from '../data/mockData'
...
const PIE_COLORS = ['#16a34a', '#4ade80', '#86efac', '#bbf7d0']
    ...
    <div>
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-md text-sm text-brand-100">
              Here's what's happening at OJAIN today — {orders.length} recent orders need your attention.
            </p>
          </div>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="card p-5">
          <h3 className="mb-4 font-semibold text-slate-800">Sales by Category</h3>
